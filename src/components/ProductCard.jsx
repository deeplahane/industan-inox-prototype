...
const ProductCard = ({name, vendor, price, image, dept}) => {
    return (
        <div class="w-full min-w-fit sm:max-w-20 md:w-1/2 lg:w-1/4 pl-5 pr-5 mb-5 lg:pl-2 lg:pr-2">
            <div class="bg-white sm:max-w-20 rounded-lg m-h-64 p-2  border border-gray-200 transform hover:translate-y-2 hover:shadow-xl transition duration-300">
                <figure class="mb-2">
                    ...
                    <img src={image} alt="" class="w-64 h-64 ml-auto mr-auto" />
                </figure>
                <div class="rounded-lg p-4 bg-purple-700 flex flex-col">
                    <div>
                        <h5 class="text-white text-2xl font-bold leading-none line-clamp	">
                            {name}
                        </h5>
